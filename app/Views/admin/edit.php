    ...
    <main>
        ...
        <section id="addMenuForm" class="addMenuForm">
            <div class="container text-white mb-4">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <form action="/dashboard/menu/update/<?= $menu_id; ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="menu_id" value="<?= $menu_id; ?>">
                            <input type="hidden" name="old_menu_img" value="<?= $menu_img; ?>">
                                ...
                                <div class="col-sm-10 px-0">
                                    <select class="custom-select <?= ($validation->hasError('menu_category')) ? 'is-invalid' : ''; ?>" name="menu_category">
                                        ...
                                        <?php foreach ($categories as $category) : ?>
                                            <?php if ($category['category_id'] === $menu_category_id) : ?>
                            ...
                            <div class="form-group row py-1">
                                ...
                                <div class="col-sm-10 px-0">
                                    <input type="text" class="form-control <?= ($validation->hasError('menu_name')) ? 'is-invalid' : ''; ?>" id="name" name="menu_name" placeholder="Menu name" value="<?= (old('menu_name')) ? old('menu_name') : $menu_name; ?>" autofocus>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row py-1">
                                ...
                                <div class="col-sm-9 px-0">
                                    <input type="number" class="form-control <?= ($validation->hasError('menu_price')) ? 'is-invalid' : ''; ?>" id="price" name="menu_price" placeholder="Price" value="<?= (old('menu_price')) ? old('menu_price') : $menu_price; ?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row py-1">
                                ...
                                <div class="col-sm-10 px-0">
                                    <textarea class="form-control <?= ($validation->hasError('menu_desc')) ? 'is-invalid' : ''; ?>" id="description" name="menu_desc" rows="3" placeholder="Description"><?= (old('menu_desc')) ? old('menu_desc') : $menu_desc; ?></textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row py-1">
                                ...
                                <div class="col-sm-2">
                                    <img src="/assets/img/menu-restoran/<?= $menu_img; ?>" class="img-thumbnail img-preview">
                                </div>
                                <div class="col-sm-8 custom-file">
                                    ...
                                    <label for="menu_img" class="custom-file-label"><?= $menu_img; ?></label>
                                </div>
                            </div>
