...
<div class="admin">
    ...
    <?php if (session()->getFlashdata('alert_msg')) : ?>
        <div class="alert alert-success" role="alert">
            <?= session()->getFlashdata('alert_msg'); ?>
        </div>
    <?php endif; ?>
    ...
    <main>
        ...
        <section id="menu" class="menu">
            <div class="container text-white">
                ...
                <div class="row">
                    <div class="col">
                        <table id="listMenuTable" class="table table-striped table-bordered table-dark" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Nama</th>
                            ...
                            <tbody>
                                <?php foreach ($menus as $idx => $m) : ?>
                                    <tr>
                                        ...
                                        <td><?= $m['deskripsi']; ?></td>
                                        <td>
                                            <img src="/assets/img/menu-restoran/<?= $m['gambar']; ?>" alt="Gambar Menu" width="150">
                                        </td>
                                        <td>
